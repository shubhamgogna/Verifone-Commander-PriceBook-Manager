...
namespace VerifoneCommander.PriceBookManager.Core
{
    ...
    {
        public const int Ean13LengthWithoutCheckDigit = 12;
        public const int Ean13LengthWithCheckDigit = 13;
        ...
        public static bool CanBeEan13(long upc, bool hasCheckDigit)
        {
            if (hasCheckDigit)
            {
                return upc <= MaxEan13;
            ...
            {
                return upc <= MaxEan13WithoutCheckDigit;
            }
        }
